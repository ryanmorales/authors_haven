...
class Profile(TimeStampedModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_('phone number'), max_length=30, default="+639062244226")
    ...
    city = models.CharField(verbose_name=_("city"), max_length=100, default="Cebu", blank=False, null=False)
